...
export default function EditFounderDetailsPage() {
  ...
  const loadProfileData = useCallback(async () => {
    if (slug) {
      setIsLoading(true);
      try {
        const response = await fetch(`/api/founder-details?id=${slug}`);
            ...
            <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
              <div className='bg-white p-8 rounded-2xl shadow-2xl max-w-md mx-4 text-center'>
                <div className='mb-4'>
                  ...
                  <p className='text-gray-600'>Your profile has been updated. We&apos;re redirecting you to your dashboard.</p>
                </div>
